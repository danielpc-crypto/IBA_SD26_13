...
//delete account api call test
describe('Delete account API behaviour', () => {
  test('calls DELETE /users with username and password on confirm', async () => {
  ...
  test('shows alert and keeps dialog open on failed delete', async () => {
    ...
    await waitFor(() => {
      expect(window.alert).toHaveBeenCalledWith(expect.stringMatching(/failed to delete/i));
    });
  });
  ...
  test('handles network error gracefully', async () => {
    ...
    await waitFor(() => {
      expect(window.alert).toHaveBeenCalledWith(expect.stringMatching(/error occurred/i));
    });
  });
});